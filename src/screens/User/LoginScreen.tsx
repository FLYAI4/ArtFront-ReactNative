...
const LoginScreen = () => {
  ...
  return (
    <KeyboardAwareScrollView contentContainerStyle={{ width:'100%', height:'100%', backgroundColor: theme.backgroundWhite, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
