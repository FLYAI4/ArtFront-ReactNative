...
const HomeScreen = () => {
  ...
  const image1 = require('../../assets/image/Popular/1.jpg');
  const image2 = require('../../assets/image/Popular/2.jpg');
  const image3 = require('../../assets/image/Popular/3.jpg');
  const image4 = require('../../assets/image/Popular/4.jpg');
  const image5 = require('../../assets/image/Popular/5.jpg');
  const image6 = require('../../assets/image/Popular/6.jpg');
  ...
  return (
    <View style={{width: '100%', height: '100%', position: 'relative'}}>
      <ScrollView style={{backgroundColor: theme.backgroundWhite}}>
        ...
        <Image source={logo} style={{width: 80, height: 80, marginRight: 20, backgroundColor: 'lightgray'}}/>
          <View>
        ...
        <View>
          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
              <View style={{ flexDirection: 'row', marginLeft: 20, marginRight: 20}}>
                  ...
                  <Image source={image6} style={{width: 160, height: 200, borderRadius: 20, marginRight: 20}} />
