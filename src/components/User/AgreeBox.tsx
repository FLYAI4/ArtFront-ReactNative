...
const AgreeBox = ({agree, setAgree}: AgreeBoxProps) => {
  ...
  return (
    <View style={{width: '100%', marginTop: 19, display: 'flex', flexDirection: 'column'}}>
      <TouchableOpacity onPress={handleAllAgree} style={{width: '100%', borderRadius: 5, display: 'flex', flexDirection: 'row', padding: 12, alignItems: 'center', backgroundColor: '#F8F8FA'}}>
        <AntDesign name={agree[0]===true ? "checkcircle" : "checkcircleo"} size={18} color='#333333' />
      ...
      <View style={{width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingRight: 32}}>
        <TouchableOpacity style={{width: '100%', display: 'flex', flexDirection: 'row', padding: 12, alignItems: 'center'}} onPress={()=>setAgree([agree[0], !agree[1], agree[2]])}>
            <AntDesign name={agree[1]===true ? "checkcircle" : "checkcircleo"}  size={18} color='#333333' />
      ...
      <View style={{width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingRight: 32}}>
        <TouchableOpacity style={{width: '100%', display: 'flex', flexDirection: 'row', padding: 12, alignItems: 'center'}} onPress={()=>setAgree([agree[0], agree[1], !agree[2]])}>
            <AntDesign name={agree[2]===true ? "checkcircle" : "checkcircleo"}  size={18} color='#333333' />
